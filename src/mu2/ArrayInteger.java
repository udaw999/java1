...
//        System.out.println();
    ...
    public boolean add(ArrayInteger num) {
        ...
        for (byte values : digits) {           System.out.print("," + values);       }
        System.out.println();
        for (byte values : arrayInteger1.digits) {           System.out.print("," + values);       }
        System.out.println();
        String num1 = "";
        String num2 = "";
    ...
    public static void main(String[] args) {
        ...
        BigInteger value = BigInteger.valueOf(1202189944l);
        arrayInteger.fromInt(value);

        ArrayInteger arrayInteger2 = new ArrayInteger(8);
        BigInteger value2 = BigInteger.valueOf(36095555555l);
